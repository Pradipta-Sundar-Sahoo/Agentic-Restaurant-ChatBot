...
class LLMClient:
    def __init__(self):
        ...
        if not api_key:
            logger.error("Hugging Face API key not found in environment variable HF_API_KEY")
            raise ValueError("Missing Hugging Face API key. Set the HF_API_KEY environment variable.")
